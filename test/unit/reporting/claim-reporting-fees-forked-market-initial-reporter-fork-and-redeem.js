...
describe.only("reporting/claim-reporting-fees-forked-market", function () {
  ...
  describe("When a forked market exists in the current universe", function () {
    describe("and estimateGas is true", function () {
      ...
      describe("InitialReporter.forkAndRedeem", function () {
        ...
        it("should receive the expected input parameters for each call to InitialReport.forkAndRedeem", function () {
          var expectedInitialReportForkAndRedeemAddresses = [
            "0xf1Add00000000000000000000000000000000000",
          ];
          for (var i = 0; i < expectedInitialReportForkAndRedeemAddresses[i]; i++) {
            var expectedInput = {
              redeemer: REDEEMER_ADDRESS,
              tx: {
                to: expectedInitialReportForkAndRedeemAddresses[i],
                estimateGas: true,
              },
            };
            var actualInput = initialReporterForkAndRedeemStub.args[i][0];
      ...
      describe("InitialReporter.redeem", function () {
        it("should be called 0 times", function () {
          sinon.assert.callCount(initialReporterRedeemStub, 0);
        });
      });
